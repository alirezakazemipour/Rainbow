...
def get_params():
    ...
    parser.add_argument("--interval", default=4, type=int, help="The interval specifies how often different"
                                                        "parameters should be saved and printed, counted by episodes")
